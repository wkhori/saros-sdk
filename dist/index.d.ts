 ...
 */
declare function calculateSwapOutput(amountIn: bigint, reserveIn: bigint, reserveOut: bigint, tradeFeeNumerator: bigint, tradeFeeDenominator: bigint): bigint;
/**
 * Calculate price impact percentage
 */
declare function calculatePriceImpact(amountIn: bigint, amountOut: bigint, reserveIn: bigint, reserveOut: bigint): number;
/**
 ...
 */
declare function deriveFarmUserPoolAddress(user: PublicKey, poolAddress: PublicKey, programId: PublicKey): [PublicKey, number];
declare function deriveFarmUserPoolRewardAddress(user: PublicKey, poolReward: PublicKey, programId: PublicKey): [PublicKey, number];
...
export { type AMMPairAccount, AMM_PROGRAM_IDS, type AddLiquidityParams, CURVE_TYPE_MAP, type ClaimRewardParams, type CreatePairParams, type CreatePairResult, DEFAULT_FEES, DEFAULT_SWAP_CALCULATOR, FARM_IDL, FARM_PROGRAM_IDS, type FeeMetadata, type Fees, MODE, type PairMetadata, type PoolAccount, type PoolState, type PoolType, type QuoteParams, type QuoteResponse, type RemoveLiquidityParams, SAROS_FEE_OWNER, SWAP_ACCOUNT_SIZE, SarosAMM, type SarosAMMConfig, SarosAMMError, SarosAMMErrorCode, SarosAMMPair, type SarosAPIFarmInfo, SarosAPIService, type SarosAPIStakeInfo, SarosBaseService, SarosFarm, type SarosFarmIDL, type SarosSwap, type StakeParams, type SwapCurve, SwapCurveType, type SwapParams, type TokenInfo, type UnstakeParams, type UserPosition, type UserRewardPosition, calculatePriceImpact, calculateSwapOutput, deriveFarmPoolAuthority, deriveFarmPoolRewardAuthority, deriveFarmUserPoolAddress, deriveFarmUserPoolRewardAddress, derivePoolAuthority, getMinOutputWithSlippage };
